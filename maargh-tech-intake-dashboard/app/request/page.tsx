...
.tiger-visual{position:absolute;inset:0;background-image:linear-gradient(90deg,rgba(8,6,4,.02) 0%,rgba(8,6,4,.02) 42%,rgba(8,6,4,.76) 76%,#090706 100%),url('/tiger-bg.jpg');background-size:cover;background-position:center center;background-repeat:no-repeat;transform:none}
