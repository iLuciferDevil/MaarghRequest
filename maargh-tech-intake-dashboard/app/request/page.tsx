...
.tiger-visual{position:absolute;inset:0;background-image:linear-gradient(90deg,rgba(8,6,4,.02) 0%,rgba(8,6,4,.02) 42%,rgba(8,6,4,.76) 76%,#090706 100%),url('/ChatGPT%20Image%20Sep%2021,%202026,%2006_16_56%20PM.png?v=20260921');background-size:cover;background-position:center center;background-repeat:no-repeat;transform:none}
